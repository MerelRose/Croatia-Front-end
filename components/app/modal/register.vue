    ...
    <div id="register-pop-up" class="pop-up-wrapper">
      ...
      <div class="pop-up-container">
        ...
        <form class="form" @submit.prevent="handleSubmit">
          ...
          <input type="email" id="email" name="email" class="input" autocomplete="email" required v-model="email" /><br />

          <label for="first-name">First Name:</label><br />
          <input type="text" id="first-name" name="first-name" class="input" autocomplete="given-name" required v-model="firstName" /><br />
          <label for="last-name">Last Name:</label><br />
          <input type="text" id="last-name" name="last-name" class="input" autocomplete="family-name" required v-model="lastName" /><br />
